...
class RecommendationsControllerTest < ActionController::TestCase
  ...
  test "should create recommendation" do
    assert_difference('Recommendation.count') do
      post :create, recommendation: { Action: @recommendation.Action, Auditee: @recommendation.Auditee, Auditor: @recommendation.Auditor, Priority: @recommendation.Priority, Reference: @recommendation.Reference, Status: @recommendation.Status, Title: @recommendation.Title }
    end
  ...
  test "should update recommendation" do
    put :update, id: @recommendation, recommendation: { Action: @recommendation.Action, Auditee: @recommendation.Auditee, Auditor: @recommendation.Auditor, Priority: @recommendation.Priority, Reference: @recommendation.Reference, Status: @recommendation.Status, Title: @recommendation.Title }
    assert_redirected_to recommendation_path(assigns(:recommendation))
  end
